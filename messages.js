...
window.sendChatMessage = async function () {
    ...
    try {
        ...
        // 🚀 new_message notification — chats never notified at all before. Kept
        // generic ("New Chat", no message content) per how this was asked for;
        // the edge function also checks the recipient's per-conversation mute
        // setting for this sender before actually sending a push.
        createNotification({ userId: activeChat.userId, senderId: myProfile.id, type: 'new_message' });
    } catch (error) {
...
window.sendPostToChat = async function (receiverId, postId) {
    try {
        ...
        createNotification({ userId: receiverId, senderId: myProfile.id, type: 'new_message' });
